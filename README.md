...
### Бот планировался использоваться для прохождения теста Белбина на Школе Кураторов 2020 в НИЯУ МИФИ

#### Необходимое для запуска:
- База данных MySQL (MariaDB/Percona) - подходящая база поднимается командой
~~~~
docker-compose up
~~~~
